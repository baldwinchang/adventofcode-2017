...
puzzle_input = """vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
for line in puzzle_input.split("\n"):
    sanity_dictionary = set()
    valid = True
    for phrase in line.split(" "):
        if phrase not in sanity_dictionary:
            sanity_dictionary.add(phrase)
        else:
            valid = False
            break
    if valid:
...
for line in puzzle_input.split("\n"):
    ...
    for phrase in line.split(" "):
        ...
        if sorted_phrase not in sanity_dictionary:
            sanity_dictionary.add(sorted_phrase)
        else:
            valid = False
            break
    if valid:
